...
augroup seeingIsBelievingSettings
  ...
  autocmd!
  autocmd FileType ruby nmap <buffer> <Leader>rb :call SibAnnotateAll("%")<CR>;
  autocmd FileType ruby nmap <buffer> <Leader>nr :call SibAnnotateMarked("%")<CR>;
  autocmd FileType ruby nmap <buffer> <Leader>vr :call SibCleanAnnotations("%")<CR>;
  ...
  autocmd FileType ruby vmap <buffer> <Leader>br :call SibAnnotateAll("'<,'>")<CR>;
  autocmd FileType ruby vmap <buffer> <Leader>nr :call SibAnnotateMarked("'<,'>")<CR>;
  autocmd FileType ruby vmap <buffer> <Leader>vr :call SibCleanAnnotations("'<,'>")<CR>;
augroup END
